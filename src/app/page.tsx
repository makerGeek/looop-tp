...
export default function HomePage() {
  ...
  return (
    <div
      className="mx-auto w-full max-w-7xl px-6 pb-20 pt-10"
      data-testid="home-page"
    >
      <section className="mb-10 rounded-2xl border bg-gradient-to-br from-primary/10 via-background to-background p-8">
        ...
        <p className="mt-4 max-w-2xl text-muted-foreground">
          30 interactive, progressively-difficult exercises covering React 19,
          Next.js 15, TanStack, Zustand, Tailwind v4, Vitest, Cypress, and the
          full 2026 toolchain. Write code in the browser, see it run instantly,
          collect XP.
        </p>
